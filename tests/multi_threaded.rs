...
use common::{CounterInnerMutSubscriber, CounterSubscriber, CounterSubscriberWithData};
...
fn test_diff_type_subscribers() {
    ...
    let thread_handle = thread::spawn(move || {
        // We cannot run the event manager loop for ever. Let's just run it for 100 iterations.
        for _ in 0..100 {
